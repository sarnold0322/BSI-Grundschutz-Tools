...
# Pfad zu CMD
$pathToFile = "C:\Windows\system32\WindowsPowerShell\v1.0\powershell.exe"
...
try {
    ...
    $process.Kill()
    $result = 0
    $output = "Powershell wurde erfolgreich gestartet und beendet."
} catch {
    $result = 1
    $output = "Powershell konnte nicht gestartet werden."
}
